...
//Se pasan los datos de la cola temporal a la cola original.   
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    if (!cola.colaLLena()) {
                        //Se agrega siempre que la cola no esté llena.      
                        cola.agregar(dato);
                ...
                case 2:
                    if (!cola.colaVacia()) {
                        //Para poder eliminar el dato del frente, la cola no debe estar vacía.        
